...
export function CategoryCard({
  ...
  return (
    ...
    >
      <Link to={`/category/${id}`} className="block group h-full">
        <div className="relative h-full overflow-hidden rounded-sm border-2 border-wood-600 bg-wood-900 shadow-lg transition-all duration-300 group-hover:border-gold-500 group-hover:shadow-glow-bronze group-hover:-translate-y-1">
          ...
          <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-wood-500 rounded-tl-sm z-20 group-hover:border-gold-600" />
          <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-wood-500 rounded-tr-sm z-20 group-hover:border-gold-600" />
          <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-wood-500 rounded-bl-sm z-20 group-hover:border-gold-600" />
          <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-wood-500 rounded-br-sm z-20 group-hover:border-gold-600" />
        </div>
      </Link>
    </motion.div>
  )
